...
-- so re-running this file against an already-bootstrapped database is safe,
-- matching the pattern used by the other shipped schema files.
DROP TABLE IF EXISTS ref.country CASCADE;
DROP TABLE IF EXISTS ref.currency CASCADE;
DROP TABLE IF EXISTS ref.reference_codes CASCADE;
DROP TABLE IF EXISTS ref.product_catalog CASCADE;
DROP TABLE IF EXISTS ref.rate_schedule CASCADE;
DROP TABLE IF EXISTS audit.audit_log CASCADE;
DROP TABLE IF EXISTS audit.role CASCADE;
DROP TABLE IF EXISTS audit.permission CASCADE;
DROP TABLE IF EXISTS audit.role_permission CASCADE;
DROP TABLE IF EXISTS audit.api_key CASCADE;
DROP TABLE IF EXISTS audit.session CASCADE;
DROP TABLE IF EXISTS audit.user_role CASCADE;
DROP TABLE IF EXISTS audit.system_config CASCADE;
DROP TABLE IF EXISTS party.party CASCADE;
DROP TABLE IF EXISTS party.individual CASCADE;
DROP TABLE IF EXISTS party.organization CASCADE;
DROP TABLE IF EXISTS party.party_address CASCADE;
DROP TABLE IF EXISTS party.party_contact CASCADE;
DROP TABLE IF EXISTS party.party_identifier CASCADE;
DROP TABLE IF EXISTS party.party_relationship CASCADE;
DROP TABLE IF EXISTS party.party_risk_profile CASCADE;
DROP TABLE IF EXISTS party.party_kyc CASCADE;
DROP TABLE IF EXISTS party.party_document CASCADE;
DROP TABLE IF EXISTS party.party_preference CASCADE;
DROP TABLE IF EXISTS party.party_segment CASCADE;
DROP TABLE IF EXISTS account.account_product CASCADE;
DROP TABLE IF EXISTS account.account CASCADE;
DROP TABLE IF EXISTS account.deposit_account CASCADE;
DROP TABLE IF EXISTS account.account_balance CASCADE;
DROP TABLE IF EXISTS account.account_interest CASCADE;
DROP TABLE IF EXISTS account.account_statement CASCADE;
DROP TABLE IF EXISTS account.account_beneficiary CASCADE;
DROP TABLE IF EXISTS account.account_owner CASCADE;
DROP TABLE IF EXISTS account.account_restriction CASCADE;
DROP TABLE IF EXISTS account.account_fee CASCADE;
DROP TABLE IF EXISTS txn.transaction CASCADE;
DROP TABLE IF EXISTS txn.transaction_leg CASCADE;
DROP TABLE IF EXISTS txn.transaction_reversal CASCADE;
DROP TABLE IF EXISTS txn.transaction_fee CASCADE;
DROP TABLE IF EXISTS txn.transaction_metadata CASCADE;
DROP TABLE IF EXISTS txn.wire_transfer CASCADE;
DROP TABLE IF EXISTS txn.ach_entry CASCADE;
DROP TABLE IF EXISTS txn.check_item CASCADE;
DROP TABLE IF EXISTS lending.loan_application CASCADE;
DROP TABLE IF EXISTS lending.loan CASCADE;
DROP TABLE IF EXISTS lending.loan_collateral CASCADE;
DROP TABLE IF EXISTS lending.loan_schedule CASCADE;
DROP TABLE IF EXISTS lending.loan_payment CASCADE;
DROP TABLE IF EXISTS lending.loan_modification CASCADE;
DROP TABLE IF EXISTS lending.credit_line CASCADE;
DROP TABLE IF EXISTS lending.credit_draw CASCADE;
DROP TABLE IF EXISTS lending.guarantee CASCADE;
DROP TABLE IF EXISTS lending.loan_covenant CASCADE;
DROP TABLE IF EXISTS lending.appraisal CASCADE;
DROP TABLE IF EXISTS lending.loan_charge CASCADE;
DROP TABLE IF EXISTS card.card_product CASCADE;
DROP TABLE IF EXISTS card.card_account CASCADE;
DROP TABLE IF EXISTS card.card CASCADE;
DROP TABLE IF EXISTS card.card_transaction CASCADE;
DROP TABLE IF EXISTS card.card_authorization CASCADE;
DROP TABLE IF EXISTS card.card_dispute CASCADE;
DROP TABLE IF EXISTS card.card_reward CASCADE;
DROP TABLE IF EXISTS card.card_limit CASCADE;
DROP TABLE IF EXISTS card.card_statement CASCADE;
DROP TABLE IF EXISTS card.card_merchant_restriction CASCADE;
DROP TABLE IF EXISTS compliance.aml_alert CASCADE;
DROP TABLE IF EXISTS compliance.sar_filing CASCADE;
DROP TABLE IF EXISTS compliance.ctr_filing CASCADE;
DROP TABLE IF EXISTS compliance.sanctions_screening CASCADE;
DROP TABLE IF EXISTS compliance.pep_record CASCADE;
DROP TABLE IF EXISTS compliance.adverse_media CASCADE;
DROP TABLE IF EXISTS compliance.compliance_case CASCADE;
DROP TABLE IF EXISTS compliance.regulatory_report CASCADE;
DROP TABLE IF EXISTS ops.branch CASCADE;
DROP TABLE IF EXISTS ops.employee CASCADE;
DROP TABLE IF EXISTS ops.channel CASCADE;
DROP TABLE IF EXISTS ops.service_request CASCADE;
DROP TABLE IF EXISTS ops.work_item CASCADE;
DROP TABLE IF EXISTS ops.notification CASCADE;
DROP TABLE IF EXISTS ops.batch_job CASCADE;
DROP TABLE IF EXISTS ops.batch_job_run CASCADE;
DROP TABLE IF EXISTS ops.scheduled_task CASCADE;
DROP TABLE IF EXISTS ops.event_outbox CASCADE;
DROP TABLE IF EXISTS wart.customer_summary CASCADE;
DROP TABLE IF EXISTS wart.legacy_account_map CASCADE;
DROP TABLE IF EXISTS wart.card_transaction_flat CASCADE;
DROP TABLE IF EXISTS wart.transaction_staging CASCADE;
DROP TABLE IF EXISTS wart.reporting_cache CASCADE;
