...
DROP TABLE IF EXISTS sf_core.territory2model CASCADE;
DROP TABLE IF EXISTS sf_core.territory2type CASCADE;
DROP TABLE IF EXISTS sf_core.territory2 CASCADE;
DROP TABLE IF EXISTS sf_core.userterritory2association CASCADE;
...
DROP TABLE IF EXISTS sf_sales.product2 CASCADE;
DROP TABLE IF EXISTS sf_sales.pricebook CASCADE;
DROP TABLE IF EXISTS sf_sales.pricebook2 CASCADE;
